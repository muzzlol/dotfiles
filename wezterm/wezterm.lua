...
config.inactive_pane_hsb = {
  saturation = 0.85,  -- Keep original colors
...
config.keys = {
    ...
    -- tmux window switching via Karabiner hyper+arrows: Cmd+Opt+Arrows → sends M-J / M-: to tmux
    { key = 'LeftArrow', mods = 'CMD|ALT', action = wezterm.action.SendKey { key = 'J', mods = 'ALT' } },
    { key = 'RightArrow', mods = 'CMD|ALT', action = wezterm.action.SendKey { key = ':', mods = 'ALT' } },

    -- wezterm pane/split management
